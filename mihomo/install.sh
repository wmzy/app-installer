...
echo ""
print_info "系统代理管理:"
echo "• 启用系统代理: $SCRIPT_DIR/service-control.sh proxy-on"
echo "• 禁用系统代理: $SCRIPT_DIR/service-control.sh proxy-off"
echo "• 查看代理状态: $SCRIPT_DIR/service-control.sh proxy-status"
echo "• 独立代理管理: sudo $SCRIPT_DIR/proxy-settings.sh {enable|disable|status}"